...
Foreach ($domain in $AllDomains){
    $Keystatus = (get-DkimSigningConfig -identity $domain.domainname)
    ...
    if ($Keystatus -eq $Null){
        write-host -foregroundcolor red "$Domain does not have any DKIM Keys, skipping!"
    }
    else{
